...
void Game::initGui()
{
	...
	if (!this->font.loadFromFile("Fonts/YuseiMagic-Regular.ttf"))
		std::cout << "poshel nahui pidrila";

	//Init point text
	this->pointText.setFont(font);
	this->pointText.setCharacterSize(25);
	this->pointText.setFillColor(sf::Color::White);
	this->pointText.setString("TEXT CYKA BLYAT");
	this->pointText.setPosition(this->window->getSize().x - 50.f, 0.f);
...
void Game::initWorld()
{
	...
	this->background.setScale(0.8f, 0.9f);
}
...
void Game::updateInput()
{
	...
	if (sf::Mouse::isButtonPressed(sf::Mouse::Left) && this->player->canAttack())
	{
		this->bullets.push_back(new Bullet(this->textures["BULLET"],
			this->player->getPos().x + (this->player->getSize().x / 2),
